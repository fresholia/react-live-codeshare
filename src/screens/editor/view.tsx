...
import { ErrorLayout, LoadingLayout, CodeActions, SettingsWindow } from 'components'

import { SocketProvider, setClientRoom, updateCodeData, socketConnected } from 'providers/socket'

import { saveFile } from 'providers/editor'

import { editorStateReducer, initialEditorState } from 'hooks/reducers/editor';

import { ICodeBlocks, IClientActions, IInputActions } from 'types/codeview';
...
CodeEditor.getLayout = (page: ReactElement) => {
    return (
        <>
            <Head>
                <title>In editor - code2gether</title>
            </Head>
            {page}
        </>
    )
