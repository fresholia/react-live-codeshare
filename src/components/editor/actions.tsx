import styles from 'screens/editor/_editor.module.scss';

import { LogoIcon, SettingsIcon, DownloadIcon, PlusIcon, ThemeIcon, AboutIcon } from 'utils/icons'

import type { ICodeActionProps } from 'types/codeview'

export function CodeActions(e: ICodeActionProps) {
    return (
